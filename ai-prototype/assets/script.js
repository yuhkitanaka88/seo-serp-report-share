      ...
      <footer class="site-footer">
        <div class="container">
          <div class="footer-grid">
            ...
            <div class="footer-group"><h2>設計資料</h2><a href="${ROOT}guide/index.html">目的別ナビ</a><a href="${href('/business/site-map/')}">案Aサイトマップ</a><a href="${ROOT}requirements/index.html">サイト構造・キーワード要件書</a><a href="${ROOT}strategy/index.html">ポートフォリオ方針</a><a href="${ROOT}archive/index.html">アーカイブ</a><a href="${href('/business/about/')}">研修事業について</a><a href="${href('/business/faq/')}">よくある質問</a></div>
          </div>
    ...
    return `
      <dialog id="siteMapDialog" class="site-map-dialog">
        ...
        <div class="dialog-body">
          ...
          <div class="dialog-actions"><a class="button button-primary" href="${href('/business/site-map/')}">案Aサイトマップを大きく見る</a><a class="button" href="${ROOT}guide/index.html">目的別ナビ</a><a class="button" href="${ROOT}requirements/index.html">要件書を開く</a></div>
        </div>
      </dialog>`;
  }
